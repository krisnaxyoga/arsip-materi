        ...
        <div class="col-lg-6">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="@if($model->exists) {{ route('sertifikatbypetugas.update', $model->id) }} @else {{ route('sertifikatbypetugas.store') }} @endif" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <input type="text" value="{{$data->id}}" name="anggota_id" hidden>
                        </div>
                        <div class="form-group">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('sertifikatbypetugas.show',$item->id) }}" class="btn btn-datatable btn-icon btn-transparent-dark mr-2"><i data-feather="edit"></i></a>

                                    <form class="d-inline" action="{{ route('sertifikatbypetugas.destroy',$item->id) }}" method="POST" onSubmit="return confirm('Apakah anda yakin akan menghapus data ini?');">
                                        @csrf
                                        @method('delete')
