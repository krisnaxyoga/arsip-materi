                ...
                <div class="card-body">
                    ...
                    <form action="@if($model->exists) {{ route('petugas.update', $model->id) }} @else {{ route('petugas.store') }} @endif" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-solid" name="jabatan" type="text" placeholder="jabatan" value="{{ old('jabatan', $model->jabatan) }}" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-solid" name="email" type="email" placeholder="email" value="{{ old('email',$model->user->email) }}" />
                        @else
                        <label class="small mb-1">Email <span class="text-danger">*</span></label>
                            <input class="form-control form-control-solid" name="email" type="email" placeholder="email" value="{{ old('email') }}" />
                        @endif
                        </div>
                        <div class="form-group">
